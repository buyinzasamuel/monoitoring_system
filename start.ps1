...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a160h4cq9f9zk1-ats.iot.eu-north-1.amazonaws.com --ca_file root-CA.crt --cert lht65n-01-temp-humidity-sensor.cert.pem --key lht65n-01-temp-humidity-sensor.private.key --client_id basicPubSub --topic sdk/test/python --count 0